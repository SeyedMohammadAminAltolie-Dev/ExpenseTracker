...
extension Category {
    ...
    static let entertaiment = Category(id: 3, name: "Entertaiment", icon: .film)
    ...
    static let moviewsAndDVDs = Category(id: 301, name: "Movies & DVDs", icon: .film,mainCategoryId: 3)
    ...
    static let rent = Category(id: 601, name: "Rent", icon: .car_alt,mainCategoryId: 6)
    static let homeSupplies = Category(id: 602, name: "Home Supplies", icon: .lightbulb,mainCategoryId: 7)
    static let paycheque = Category(id: 701, name: "Paycheque", icon: .dollar_sign, mainCategoryId: 8)
    static let software = Category(id: 801, name: "Software", icon: .icons, mainCategoryId: 8)
    static let creditCardPeyment = Category(id: 901, name: "Credit Card Peyment", icon: .exchange_alt, mainCategoryId: 9)
}
